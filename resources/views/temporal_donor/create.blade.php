          ...
          <form action="{{route('temporal_donors.single-store')}}" method="POST">
            ...
            <div class="row my-1">
              <div class="col-12 col-md-4 pr-md-1">
                ...
                <input type="text" id="name" name="name" autofocus="true" class="form-control" required>
              </div>
              <div class="col-12 col-md-4 px-md-1">
                <label>Apellido paterno <span class="text-danger text-sm">*</span></label>
                <input type="text" id="parental_surname" name="parental_surname" class="form-control" required>
              </div>
            ...
            <div class="row">
              <div class="col-12 col-md-4 pr-md-1">
                ...
                <input type="text" maxlength="18" class="form-control" id="curp" name="curp" placeholder="Ingrese su curp" required>
              </div>
              <div class="col-12 col-md-4 px-md-1">
            ...
            <div class="row my-1">
              ...
              <div class="col-6 col-md-4 px-md-1">
                ...
                <input type="tel" id="mobile" name="mobile" class="form-control" placeholder="" value="" >
              </div>
