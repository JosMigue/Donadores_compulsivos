    ...
    <div>
      ...
      <modal-donor-component :campaign = campaignid v-on:added-donor-campaign-event="getDonorsInCampaign()"></modal-donor-component>
        ...
        <table class="table table-hover table-striped table-sm text-center">
          ...
          <!-- <tbody> -->
            <paginate name="campaigndonors" :list="campaigndonors" :per="5" tag="tbody">
      ...
      <paginate-links class="d-flex justify-content-center" for="campaigndonors" :simple="{prev: 'Ante', next: 'Sig'}" :classes="{'ul': 'pagination', 'li': 'page-item', 'a': 'page-link'}"></paginate-links>
    </div>
</template>
